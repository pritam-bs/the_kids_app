...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( StoryEntity story)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
return loaded(_that.story);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( StoryEntity story)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case Initial():
return initial();case Loading():
return loading();case Loaded():
return loaded(_that.story);case Error():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( StoryEntity story)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
...
class Initial implements StoryState {
  const Initial();
...
class Loading implements StoryState {
  const Loading();
...
class Loaded implements StoryState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Loaded&&(identical(other.story, story) || other.story == story));
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $StoryStateCopyWith<$Res> {
...
$StoryEntityCopyWith<$Res> get story {
  ...
  return $StoryEntityCopyWith<$Res>(_self.story, (value) {
...
class Error implements StoryState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $StoryStateCopyWith<$Res> {
