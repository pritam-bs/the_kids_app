        ...
        switch (json['exerciseType']) {
          ...
          return SentenceScrambleExerciseDto.fromJson(
            json
                ...
                case 'buildSentence':
          return BuildSentenceExerciseDto.fromJson(
            json
          );
...
return sentenceScramble(_that);case BuildSentenceExerciseDto() when buildSentence != null:
...
return sentenceScramble(_that);case BuildSentenceExerciseDto():
return buildSentence(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( MatchWordExerciseDto value)?  matchWord,TResult? Function( ListenChooseExerciseDto value)?  listenChoose,TResult? Function( SpellWordExerciseDto value)?  spellWord,TResult? Function( SentenceScrambleExerciseDto value)?  sentenceScramble,TResult? Function( BuildSentenceExerciseDto value)?  buildSentence,}){
final _that = this;
switch (_that) {
case MatchWordExerciseDto() when matchWord != null:
return matchWord(_that);case ListenChooseExerciseDto() when listenChoose != null:
...
return sentenceScramble(_that.targetGermanSentence,_that.englishTranslation,_that.scrambledWords);case BuildSentenceExerciseDto() when buildSentence != null:
return buildSentence(_that.targetGermanSentence,_that.englishTranslation,_that.sentenceWithMissingWord,_that.optionsForMissingWord,_that.correctAnswerWord);case _:
  return orElse();
...
return sentenceScramble(_that.targetGermanSentence,_that.englishTranslation,_that.scrambledWords);case BuildSentenceExerciseDto():
return buildSentence(_that.targetGermanSentence,_that.englishTranslation,_that.sentenceWithMissingWord,_that.optionsForMissingWord,_that.correctAnswerWord);case _:
  throw StateError('Unexpected subclass');
...
class BuildSentenceExerciseDto extends ExerciseDto {
  const BuildSentenceExerciseDto({required this.targetGermanSentence, required this.englishTranslation, required final  List<String> sentenceWithMissingWord, required final  List<String> optionsForMissingWord, required this.correctAnswerWord, final  String? $type}): _sentenceWithMissingWord = sentenceWithMissingWord,_optionsForMissingWord = optionsForMissingWord,$type = $type ?? 'buildSentence',super._();
  factory BuildSentenceExerciseDto.fromJson(Map<String, dynamic> json) => _$BuildSentenceExerciseDtoFromJson(json);
...
@override
String toString() {
  return 'ExerciseDto.buildSentence(targetGermanSentence: $targetGermanSentence, englishTranslation: $englishTranslation, sentenceWithMissingWord: $sentenceWithMissingWord, optionsForMissingWord: $optionsForMissingWord, correctAnswerWord: $correctAnswerWord)';
}
...
/// @nodoc
abstract mixin class $BuildSentenceExerciseDtoCopyWith<$Res> implements $ExerciseDtoCopyWith<$Res> {
  factory $BuildSentenceExerciseDtoCopyWith(BuildSentenceExerciseDto value, $Res Function(BuildSentenceExerciseDto) _then) = _$BuildSentenceExerciseDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$BuildSentenceExerciseDtoCopyWithImpl<$Res>
    implements $BuildSentenceExerciseDtoCopyWith<$Res> {
  _$BuildSentenceExerciseDtoCopyWithImpl(this._self, this._then);

  final BuildSentenceExerciseDto _self;
  final $Res Function(BuildSentenceExerciseDto) _then;
...
@pragma('vm:prefer-inline') $Res call({Object? targetGermanSentence = null,Object? englishTranslation = null,Object? sentenceWithMissingWord = null,Object? optionsForMissingWord = null,Object? correctAnswerWord = null,}) {
  return _then(BuildSentenceExerciseDto(
targetGermanSentence: null == targetGermanSentence ? _self.targetGermanSentence : targetGermanSentence // ignore: cast_nullable_to_non_nullable
as String,englishTranslation: null == englishTranslation ? _self.englishTranslation : englishTranslation // ignore: cast_nullable_to_non_nullable
